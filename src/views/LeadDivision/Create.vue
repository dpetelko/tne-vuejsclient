...
<!--          @submit.prevent="submitHandler"-->
          ...
          <div class="form-group">
            ...
            <small v-if="$v.leadDivision.country.$dirty && !$v.leadDivision.country.required" class="text-danger">Поле
              не может быть пустым</small>
            <small class="text-danger" v-else-if="$v.leadDivision.country.$dirty && !$v.leadDivision.country.minLength">
            ...
            <small class="text-danger" v-else-if="$v.leadDivision.country.$dirty && !$v.leadDivision.country.maxLength">
          ...
          <div class="form-group">
            ...
            <small v-if="$v.leadDivision.region.$dirty && !$v.leadDivision.region.required" class="text-danger">Поле не
              может быть пустым</small>
            <small class="text-danger" v-else-if="$v.leadDivision.region.$dirty && !$v.leadDivision.region.minLength">
            ...
            <small class="text-danger" v-else-if="$v.leadDivision.region.$dirty && !$v.leadDivision.region.maxLength">
          ...
          <div class="form-group">
            ...
            <small class="text-danger" v-else-if="$v.leadDivision.street.$dirty && !$v.leadDivision.street.maxLength">
          ...
          <div class="form-group">
            ...
            <small class="text-danger" v-if="$v.leadDivision.building.$dirty && !$v.leadDivision.building.minLength">
          ...
          <div class="form-group">
            ...
            <input type="submit" value="Сохранить" id="confirmSaveButton" @click.prevent="confirmSubmit()" class="btn btn-warning"/>
          </div>
        </form>
      </div>
    </div>
...
export default {
  ...
  validations: {
    leadDivision: {
      ...
      country: {required, minLength: minLength(3), maxLength: maxLength(30)},
